...
//add number of quarters
    ...
    if (cents % 25)                                   
    {
        ...
        if (x / 10 >= 1)                                //if x bigger than 10
        {
            ...
            int y = x % 10;                             //define y as remainder after division of x by 10
            counter = counter + y / 5 + y % 5;          //add quotient from division of y by 5 and remainder 
        }
        else if (x / 10 < 1)                              //else if remainder x less than 10
        {                    
            counter = counter + x / 5 + x % 5;              //add quotient from division of x by 5 and remainder 
        }
    }
