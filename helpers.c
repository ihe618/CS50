...
void blur(int height, int width, RGBTRIPLE image[height][width])
{
    ...
    for (int i = 1; i < width - 1; i++)                 // For columns 1 to width - 1
    {
        ...
        image[0][i].rgbtRed = Red / 6;                  // Average of adjacent values for each color
        image[0][i].rgbtGreen = Green / 6;
        image[0][i].rgbtBlue = Blue / 6;
    }
    ...
    for (int i = 1; i < width - 1; i++)                 // For columns 1 to width - 1
    {
        ...
        image[height - 1][i].rgbtRed = Red / 6;         // Average of adjacent values for each color
        image[height - 1][i].rgbtGreen = Green / 6;
        image[height - 1][i].rgbtBlue = Blue / 6;
    }
    // Column 0
    for (int i = 1; i < height - 1; i++)                // For rows 1 to height - 1
    {
        ...
        image[i][0].rgbtRed = Red / 6;                  // Average of adjacent values for each color
        image[i][0].rgbtGreen = Green / 6;
        image[i][0].rgbtBlue = Blue / 6;
    }
    ...
    for (int i = 1; i < height - 1; i++)                // For rows 1 to height - 1
    {
        ...
        image[i][width - 1].rgbtRed = Red / 6;          // Average of adjacent values for each color
        image[i][width - 1].rgbtGreen = Green / 6;
        image[i][width - 1].rgbtBlue = Blue / 6;
    }
    ...
    image[0][0].rgbtRed = Red / 4;                      // Average of adjacent values for each color
    image[0][0].rgbtGreen = Green / 4;
    image[0][0].rgbtBlue = Blue / 4;
    ...
    image[height - 1][0].rgbtRed = Red / 4;             // Average of adjacent values for each color
    image[height - 1][0].rgbtGreen = Green / 4;
    image[height - 1][0].rgbtBlue = Blue / 4;
    ...
    image[0][width - 1].rgbtRed = Red / 4;              // Average of adjacent values for each color
    image[0][width - 1].rgbtGreen = Green / 4;
    image[0][width - 1].rgbtBlue = Blue / 4;
    ...
    image[height - 1][width - 1].rgbtRed = Red / 4;     // Average of adjacent values for each color
    image[height - 1][width - 1].rgbtGreen = Green / 4;
    image[height - 1][width - 1].rgbtBlue = Blue / 4;
